...
export default function BusquedaMedia({ btnUser, btnAdmin }) {
            ...
            <div className="contiene-buscador">
                ...
                <div className="contiene-input">
                    ...
                    <div className="tooltip">
                        <button className="button-lupa-refresh" ><img src={process.env.PUBLIC_URL + 'buscar.png'} onClick={buscarTexto} ></img> <span className="tooltiptext">Buscar</span></button>
                    </div>
                    <div className="tooltip">
                        <button className="button-lupa-refresh" ><img src={process.env.PUBLIC_URL + 'actualizar.png'} onClick={() => window.location.reload()} ></img> <span className="tooltiptext">Actualizar</span> </button>
                    </div>
                </div>
            </div>
