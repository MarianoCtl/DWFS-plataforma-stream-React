                    ...
                    <li className='titulo-dato' key={dato.id}>
                        <div className='contiene-dato'>
                            ...
                            <div className='contiene-button'>
                                ...
                                <div className='tooltip'>
                                    {botonEditar && <button className='boton'><img src={process.env.PUBLIC_URL + 'editar.png'} key={dato.id} onClick={() => { mediaEditar(dato) }} ></img> <span className="tooltiptext">Editar</span> </button>}
                                </div>
                                <div className='tooltip'>
